        ...
        <div className={styles.summary}>
          <Fade>
            ...
            <h2>
              ...
              Loop with c# and HTML (basics) In 2020 I&apos;d managed to get an
              internship and worked as a trainee Backend developer at{" "}
              <a href="https://altooro.com/">altooro</a>. Since then, I have
              been working as Backend web developer.
            </h2>
          </Fade>
        </div>
        <Fade>
